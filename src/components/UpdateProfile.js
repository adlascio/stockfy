            ...
            <Card >
                <Card.Body >
                    ...
                    <Form>
                        ...
                        <Form.Group className='signup__form-group' id='passwordConfirmation'>
                            <Form.Label>Password Confirmation</Form.Label>
                            <Form.Control type='password' ref={passwordConfirmationRef}  placeholder='Leave blank to keep the same password'/>
                        </Form.Group>
                        <Button className='signup__button' disabled={loading} onClick={(e) => handleSubmit(e)}>Update Profile</Button>
                    </Form>
                </Card.Body>
            </Card>
