      ...
      <Card>
        <Card.Body>
          ...
          <Button
            ...
            variant="success"
            type="submit"
            onClick={(e) => createPie(e)}
            disabled={alocated !== 100}
          >
            Create new Pie
          </Button>
        </Card.Body>
